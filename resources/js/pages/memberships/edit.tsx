...
const membershipTypeOptions: { value: string; label: string }[] = [
    { value: "standard", label: "Standard" },
    { value: "premium", label: "Premium" },
    { value: "kol", label: "KOL" },
    { value: "fobb", label: "FOBB" },
];
...
const EditMembership = ({ membership }: { membership: Membership }) => {
    const methods = useForm<MembershipFormValues>({
        defaultValues: {
            ...
            best_value: Boolean(membership.best_value),
        },
                    ...
                    >
                        <div className="flex flex-col md:grid md:grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col gap-2 md:col-span-2">
                                <Label htmlFor="membership_description">
                                    Description
                                </Label>
                                <Textarea
